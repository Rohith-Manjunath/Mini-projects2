      ...
      {products.map((product) => {
        return (
          ...
          >
            ...
            <button className="bg-purple-600 text-white font-bold w-[70%] p-2 rounded-md shadow-lg active:translate-x-1 active:translate-y-1 transition-all duration-200">
              Add to cart
            </button>
          </div>
        );
